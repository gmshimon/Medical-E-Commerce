...
import { reset, updateCategory, updateCategoryImage } from "@/lib/features/categorySlice";
...
const page = ({ params }: { params: { id: string } }) => {
  const { categories,isCategoryUpdateSuccess,isCategoryUpdateError } = useSelector((state: RootState) => state.category);
    ...
    <section>
      ...
      <div className="flex justify-center">
        <div className=" bg-slate-100 px-10 py-7 w-full lg:w-[900px] rounded-md">
            <div className="flex justify-center">
            <img src={file ||category?.thumbnail} alt="category image" className="h-[100px] w-[120px]"/>
            </div>
