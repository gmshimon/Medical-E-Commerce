...
const ManageProduct = () => {
  const { products,isProductDeleteError, isProductDeleteSuccess} = useSelector((state: RootState) => state.product);
                ...
                <td>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="my-2">
                      {
                        item?.status === "active"?  <span className='badge badge-success w-[70px]'>Active</span> : <span className='badge badge-warning w-[70px]'>Inactive</span>
                      }
                      </div>
